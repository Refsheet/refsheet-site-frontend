...
const UserActionButtons: React.FC<IUserActionButtonsProps> = ({
  username,
  blocked,
  roles,
  followed,
    ...
    <div className={"user-actions"} style={{ width: 200 }}>
      {canFollow && (
        ...
        >
          ...
          <Icon
            style={{ color: followed ? "#ffca28" : "rgba(255, 255, 255, 0.7)" }}
            className="right"
          >
            person_add
          </Icon>
      ...
      {canBlock && (
        <Button
          ...
          className={"btn-block btn-flat btn-secondary margin-bottom--medium"}
        >
