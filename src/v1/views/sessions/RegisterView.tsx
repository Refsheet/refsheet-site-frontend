        ...
        <div className="narrow-container responsive">
          ...
          >
            <Row>
              <Col s={12} l={6}>
                ...
                <Row>
                  ...
                  <Select name="dob_m" value={userData.dob_d.toString()} s={3}>
                    {Array.from({ length: 31 }, (x, i) => i + 1).map((name) => (
                      <option value={name}>{name}</option>
                    ))}
                  </Select>
                  <Select name="dob_m" value={userData.dob_y.toString()} s={4}>
                    {Array.from(
                      { length: 100 },
              ...
              <Col s={12} l={6}>
                ...
                <div
                  className={
                    "tos margin-top--large padding-bottom--large white-text"
                  }
                >
                  <p className="white-text">
                    ...
                    promise to only ever be excellent to one another when on
                    this site.
                  </p>
                  <Checkbox
            ...
            <div className="form-actions margin-top--large">
              ...
              <Submit className={"right"} disabled={!registrationData.tosAgree}>
                Register
              </Submit>
            </div>
          </Form>
...
export default compose(withCurrentUser(true), withConfig)(RegisterView);
